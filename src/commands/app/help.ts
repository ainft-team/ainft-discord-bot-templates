...
import { getAppHelpMessage, getLanguageCodeFromLocale } from '../../utils';
...
const helpCommand: IDiscordSubCommand = {
  ...
  addSubcommand: (slashCommandBuilder: SlashCommandBuilder) =>
    slashCommandBuilder.addSubcommand((subcommand) =>
      subcommand
        .setName('help')
        .setDescription(`See usage for the /app subcommands`)
  ...
  execute: async (interaction: CommandInteraction) => {
    ...
    return await interaction.reply(getAppHelpMessage(lang));
  },
};
